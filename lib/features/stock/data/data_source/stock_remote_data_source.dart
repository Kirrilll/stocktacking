...
abstract class StockRemoteDataSource {
  ...
  Future<Either<IFailure, List<StorageItemDto>>> searchStorage(String search, int orgId);
  Future<Either<IFailure, List<StockDto>>> searchStocks(String search, int orgId);
