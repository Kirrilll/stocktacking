...
class LoginUseCase implements UseCase<Future<Either<IFailure, Credential>>, String> {
  ...
  @override
  Future<Either<IFailure, Credential>> execute(String phone) {
    return credentialRepository.login(phone);
  }
